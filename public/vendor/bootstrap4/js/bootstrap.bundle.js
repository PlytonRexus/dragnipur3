...
(function (global, factory) {
  ...
  function mapToStyles (_ref2) {
    ...
    const _roundOffsets = roundOffsets(offsets)
    let x = _roundOffsets.x
    let y = _roundOffsets.y
  ...
  */
  ...
  function distanceAndSkiddingToXY (placement, rects, offset) {
    ...
    const _ref = typeof offset === 'function' ? offset(Object.assign(Object.assign({}, rects), {}, {
      placement: placement
    })) : offset
    let skidding = _ref[0]
    let distance = _ref[1]
