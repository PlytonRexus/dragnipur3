...
(function ($) {
  ...
  HDisplay.prototype.init = function () {
    ...
    let elementOffset, calculatedOffset, elemDelay
  ...
  function Plugin (settings) {
    return this.each(function () {
      const $this = $(this)
      let data = $this.data('zmd.hierarchicalDisplay')
      const options = $.extend({}, HDisplay.DEFAULTS, $this.data(), typeof settings === 'object' && settings)
