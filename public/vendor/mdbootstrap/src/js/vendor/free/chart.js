 ...
 */
(function (f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f() } else if (typeof define === 'function' && define.amd) { define([], f) } else { let g; if (typeof window !== 'undefined') { g = window } else if (typeof global !== 'undefined') { g = global } else if (typeof self !== 'undefined') { g = self } else { g = this }g.Chart = f() } })(function () {
 ...
 */
    ...
    15: [function (require, module, exports) {
      ...
      const defaults = require(26)
      const elements = require(41)
      const helpers = require(46)
      ...
      module.exports = function (Chart) {
        ...
        Chart.controllers.line = Chart.DatasetController.extend({
          ...
          getPointRotation: function (point, index) {
            let pointRotation = this.chart.options.elements.point.rotation
            const dataset = this.getDataset()
            const custom = point.custom || {}
 ...
 */
	 ...
	 */
        ...
        cancelAnimation: function (chart) {
          const index = helpers.findIndex(this.animations, function (animation) {
    ...
    24: [function (require, module, exports) {
      ...
      const Animation = require(22)
      const animations = require(23)
      const defaults = require(26)
      const helpers = require(46)
      const Interaction = require(29)
      const layouts = require(31)
      const platform = require(49)
      const plugins = require(32)
      const scaleService = require(34)
      const Tooltip = require(36)
	 ...
	 */
        ...
        function getConstraintDimension (domNode, maxStyle, percentageProperty) {
          ...
          const parentNode = helpers._getParentNode(domNode)
	 ...
	 */
        ...
        helpers.getMaximumWidth = function (domNode) {
          const container = helpers._getParentNode(domNode)
          if (!container) {
            return domNode.clientWidth
          }

          const clientWidth = container.clientWidth
          const paddingLeft = helpers._calculatePadding(container, 'padding-left', clientWidth)
          const paddingRight = helpers._calculatePadding(container, 'padding-right', clientWidth)
        ...
        helpers.getMaximumHeight = function (domNode) {
          ...
          const paddingTop = helpers._calculatePadding(container, 'padding-top', clientHeight)
          const paddingBottom = helpers._calculatePadding(container, 'padding-bottom', clientHeight)
 ...
 */
	 ...
	 */
        update: function (chart, width, height) {
          ...
          function fitBox (box) {
            const minBoxSize = helpers.findNextWhere(minBoxSizes, function (minBox) {
          ...
          function finalFitVerticalBox (box) {
            const minBoxSize = helpers.findNextWhere(minBoxSizes, function (minSize) {
 ...
 */
	 ...
	 */
        ...
        draw: function (chartArea) {
          ...
          const xTickStart = options.position === 'right' ? me.left : me.right - axisWidth - tl
          ...
          linear: function (tickValue, index, ticks) {
            ...
            if (tickValue !== 0) {
              ...
              if (maxTick < 1e-4) { // all ticks are small numbers; use scientific notation
                const logTick = helpers.log10(Math.abs(tickValue))
	 ...
	 */
        roundedRect: function (ctx, x, y, width, height, radius) {
          if (radius) {
            ...
            const r = Math.min(radius, (height / 2) - epsilon, (width / 2) - epsilon)
 ...
 */
    ...
    49: [function (require, module, exports) {
      ...
      const helpers = require(46)
      const basic = require(47)
      const dom = require(48)
 ...
 */
    ...
    54: [function (require, module, exports) {
      ...
      // Default config for a category scale
        ...
        const DatasetScale = Scale.extend({
          /**
 ...
 */
      ...
      module.exports = function (Chart) {
        ...
        const LogarithmicScale = Scale.extend({
          determineDataLimits: function () {
            const me = this
            const opts = me.options
            const chart = me.chart
		 ...
		 */
          ...
          getPixelForValue: function (value) {
            const me = this
            const reverse = me.options.ticks.reverse
